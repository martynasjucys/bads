...
(function($) {
    ...
    $.fn.accordionza = function(options) {
        ...
        this.each(function() {
            ...
            // Setup the slide to start from
            $slides.removeClass(o.classSlideOpened);
            var $activeSlide = $slides.eq(o.startSlide - 1);
            ...
            var slideMinWidth = (o.slideWidthClosed === false) ? $firstSlide.find('.' + o.classHandle).first().outerWidth() : o.slideWidthClosed;
            var slideMaxWidth = width - ($slides.length - 1) * slideMinWidth + 18;
            ...
            if ($accordion.css('position') === 'static') {
            ...
            $slides.bind('slide', function() {
                ...
                $activeSlide.find('.' + o.classCaption).stop(true).animate({ top: height + 'px' }, o.captionSpeed, o.captionEasing);
                ...
                $this.find('.' + o.classCaption).stop(true).delay(o.captionDelay).animate({ top: height - o.captionHeight + 'px' }, o.captionSpeed, o.captionEasing);
            ...
            // Open the slide to start from
            $activeSlide.trigger('slide');
